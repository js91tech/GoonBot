...
HACK_VIRUS_NAME = "contagious goon"
HACK_BASE_PENALTY = 15.0
HACK_PASS_PENALTY = 2.0
HACK_TRANSFER_SECONDS = 60
HACK_COOLDOWN_SECONDS = 5 * 60

# Goon session loop — edge meter, streaks, ruin, dares.
GOON_METER_MAX = 100.0
GOON_EDGE_GAIN = (10.0, 16.0)
GOON_EDGE_COOLDOWN_SECONDS = 45.0
GOON_CHAT_GAIN = 2.0
GOON_CHAT_COOLDOWN_SECONDS = 120.0
GOON_VC_GAIN = 3.0
GOON_VC_COOLDOWN_SECONDS = 60.0
GOON_JOB_GAIN = 6.0
GOON_DAILY_GAIN = 12.0
GOON_TEASE_GAIN = (12.0, 20.0)
GOON_TEASE_COST = 250.0
GOON_TEASE_COOLDOWN_SECONDS = 60.0
GOON_FINISH_BASE = 80.0
GOON_FINISH_PER_STREAK = 25.0
GOON_RUIN_COST_BASE = 500.0
GOON_RUIN_COST_PER_STREAK = 150.0
GOON_RUIN_STEAL_FRAC = 0.45
GOON_SELF_RUIN_FRAC = 0.20
GOON_DAILY_STREAK_BONUS_PER = 0.04
GOON_DAILY_STREAK_BONUS_CAP = 0.40
GOON_WATCH_PER_PERSON = 0.15
...
GOON_CALL_INTERVAL_MINUTES = 120
GOON_CALL_INTERVAL_JITTER_MINUTES = 20
GOON_CALL_POLL_SECONDS = 45
GOON_CALL_STARTUP_DELAY_MINUTES = 2
GOON_CALL_CHAT_WINDOW_MINUTES = 20
GOON_CALL_HISTORY_LIMIT = 40
GOON_CALL_CLAIM_SECONDS = 10 * 60
GOON_CALL_REWARD = (6_000.0, 12_000.0)
GOON_CALL_CONDOMS = 3
GOON_CALL_METER_GAIN = 20.0
GOON_CALL_MIN_CHATTERS = 2
GOON_CALL_MIN_POT = 500.0
GOON_CALL_ROLE_HINTS = ("gooners", "gooner", "session")
GOON_ROUND_SECONDS = 5 * 60
GOON_ROUND_FREE_JOIN_SECONDS = 90
GOON_ROUND_METER_GAIN = 15.0
GOON_ROUND_VC_MIN = 3
GOON_ROUND_VC_BONUS = 1_500.0
GOON_ROUND_LATE_TAX = 250.0
GOON_CONDOM_METER_GAIN = 12.0
GOON_SAFE_FINISH_STREAK_KEEP = 0.50
GOON_DARE_SECONDS = 90
GOON_DARE_PAYOUT = 150.0
GOON_PERSONA_EDGE_MULT = 1.15
GOON_PERSONA_TEASE_COST_MULT = 0.75
GOON_PERSONA_RUIN_COST_MULT = 0.75
...
# Frost/storm/verdant crowd control (chill/stun/root) is disabled.
