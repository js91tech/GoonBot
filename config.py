...
BOSS_DEBUFF_DURATION_BASE_SECONDS = (10, 15)
BOSS_DEBUFF_DURATION_PER_TIER_SECONDS = (1, 2)
BOSS_DEBUFF_ATTACK_COOLDOWN_SECONDS = (3, 5)
...
ATTR_BASE_VALUE = 10
ATTR_MAX_VALUE = 50
ATTR_XP_PER_POINT = 100
ATTR_MAX_TOTAL_POINTS = 200
ATTR_MIN_DEBUFF_SECONDS = 3.0
# Per point above ATTR_BASE_VALUE:
ATTR_STR_DAMAGE_PCT = 0.015
ATTR_DEX_CRIT_PCT = 0.0075
ATTR_AGI_CC_DURATION_PCT = 0.015
ATTR_AGI_CC_PROC_RESIST_PCT = 0.0075
ATTR_AGI_ATTACK_CD_PCT = 0.005
ATTR_DEF_MITIGATION_PCT = 0.0075
ATTR_DEF_DOT_RESIST_PCT = 0.01
ATTR_VIT_HP_PER_POINT = 4
ATTR_MAX_CC_DURATION_REDUCTION = 0.60
ATTR_MAX_CC_PROC_RESIST = 0.40
