# Freaky Nikki moment art

Viral gifs from the 2026 horror film **Obsession** (Nikki / Inde Navarrette), sourced from [@bronsn on GIPHY](https://giphy.com/channel/bronsn) under the `obsession-movie` tag.
...
| `down.gif` | Counter downs a raider | [Tenor — Obsession 2026](https://tenor.com/view/obsession-obsession-2026-obsession-movie-curry-barker-nikki-gif-8643780896579921902) |
...
Alternatively, set hotlinked URLs in `config.FREAKY_NIKKI_ART_URLS` (moment key → URL). Local files take precedence when present.
