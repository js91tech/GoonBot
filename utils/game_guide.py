        ...
        GuideSection(
            ...
            pages=_static_pages(
                ...
                [
                    ...
                    "**First hour**\n"
                    "1. `/daily` — another round of goonbux\n"
                    "2. `/goon edge` — start a session (don't finish)\n"
                    "3. `/shop` — buy a weapon and armor\n"
                    "4. `/equip` — wear your gear\n"
                    "5. `/class choose` — pick Talent, Host, or Fixer\n"
                    "6. `/boss` or `/attack` — join the raid\n"
                    "7. `/balance` — pocket vs bank vault",
                    "**Core loops**\n"
                    "· **Session** — `/goon edge` / finish / ruin / tease; chat, VC, and jobs fill the meter\n"
