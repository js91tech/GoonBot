...
AVATARS: tuple[AvatarDef, ...] = (
    AvatarDef(
        "nugget_raider",
        "Goon Cave Regular",
        "Default — always edged, rarely finished. Unlocked for everyone.",
        0.0,
        "💋",
    ),
    AvatarDef(
        "duel_champion",
        "Edge Champion",
        "Won the stare-down. Still hasn't finished.",
        2_500.0,
        "🥊",
    ),
    AvatarDef(
        "raid_medic",
        "Aftercare",
        "Wipes you down so you can go again.",
        2_500.0,
        "💊",
    ),
    AvatarDef(
        "vault_mogul",
        "Tribute Host",
        "They pay. You don't have to ask twice.",
        5_000.0,
        "💰",
    ),
    AvatarDef(
