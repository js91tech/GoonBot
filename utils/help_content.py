...
HELP_PAGES: tuple[tuple[str, str], ...] = (
    ...
    (
        ...
        "**Group goon call** — every **145 minutes** in **#yappinmain** when people are typing; first yes starts a group round (Velvet art attached). Condoms: ruin shield / leak hold / safe finish.\n"
