...
HELP_PAGES: tuple[tuple[str, str], ...] = (
    ...
    (
        ...
        "**Group goon call** — every **~2 hours** in **#yappinmain** when people are typing; first yes starts a group round. `/goon dare` drops a girl and asks what you'd let her do. Condoms: ruin shield / leak hold / safe finish.\n"
