...
HELP_PAGES: tuple[tuple[str, str], ...] = (
    ...
    (
        ...
        "**Group goon call** — every **145 minutes** in **#yappinmain** when people are typing; first yes gets kisses or head from Velvet (image attached), then a group round. First **two** joiners each get a GoonCard. Condoms: ruin shield / leak hold / safe finish / late join.\n"
